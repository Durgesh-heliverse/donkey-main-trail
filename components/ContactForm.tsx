...
import { MapPin, Phone, Mail, Clock, MessageCircle, Download, Send } from "lucide-react";
...
export default function ContactForm({ data }: ContactFormProps) {
  ...
  const { title, highlightedText, description, contactInfo, quickActions, form, calendar } = data;
  ...
  const handleDateSelect = (date: string) => {
    ...
    setFormData((prev) => ({ ...prev, hikeDate: formattedDate }));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            {title || "Plan Your"}{" "}
            <span className="text-orange-600">{highlightedText || "Adventure"}</span>
          </h2>
            ...
            {quickActions && (
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                <h4 className="font-semibold text-gray-900 mb-6 flex items-center">
                  ...
                  <span className="ml-2">{quickActions.title || "Quick Actions"}</span>
                </h4>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="hikeDate" className="block text-sm font-medium text-gray-700 mb-2">
                    Preferred Hike Date
                  </label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  >
                    ...
                    {form?.fields?.groupSizeOptions?.map((option, index) => (
                ...
                <div>
                  ...
                  >
                    ...
                    {form?.fields?.experienceOptions?.map((option, index) => (
                      <option key={index} value={option.value}>
                        {option.label}
                      </option>
                    ))}
